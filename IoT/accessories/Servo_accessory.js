...
var FAKE_LOCK = {
    locked: false,
    feed_again: function () {
        PythonShell.run('/python/Servo.py', function (err) {
...
var lock = exports.accessory = new Accessory('Lock123', lockUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
lock.username = "A1:8D:3A:EA:5E:FA";
lock.pincode = "031-45-155";
...
lock
  .addService(Service.LockMechanism, "Feed Momo") // services exposed to the user should have "names" like "Fake Light" for us
