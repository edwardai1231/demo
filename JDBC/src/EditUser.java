...
public class EditUser {
 ...
 static void editMember(Scanner in, Connection conn) throws SQLException {
  ...
  System.out.println("Please enter info as follows:");
  try {
	   email = readEntry(in, "Please Enter email: ");
	   firstName = readEntry(in, "Please Enter firstName: ");
	   lastName = readEntry(in, "Please Enter lastName: ");
